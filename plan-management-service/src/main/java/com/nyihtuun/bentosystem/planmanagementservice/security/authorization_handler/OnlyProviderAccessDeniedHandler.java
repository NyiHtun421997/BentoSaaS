...
@Component
public class OnlyProviderAccessDeniedHandler implements MethodAuthorizationDeniedHandler {
    @Override
    public @Nullable Object handleDeniedInvocation(@NonNull MethodInvocation methodInvocation, @NonNull AuthorizationResult authorizationResult) {
        throw new PlanManagementDomainException(PlanManagementErrorCode.ONLY_PROVIDER_ACCESS_DENIED);
    }
}
