...
@Component
public class AdminOrProviderAccessDeniedAuthorizationHandler implements MethodAuthorizationDeniedHandler {
    @Override
    public @Nullable Object handleDeniedInvocation(@NonNull MethodInvocation methodInvocation, @NonNull AuthorizationResult authorizationResult) {
        throw new PlanManagementDomainException(PlanManagementErrorCode.ADMIN_OR_PROVIDER_ACCESS_DENIED);
    }
}
